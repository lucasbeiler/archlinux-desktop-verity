...
pacstrap -P -c -K $WORKDIR \
  ...
  sway kanshi brightnessctl xdg-desktop-portal-wlr mako swayidle swaylock swaybg ttf-jetbrains-mono arch-repro-status rclone rsync waybar xdg-desktop-portal-hyprland hyprland hyprlock hypridle hyprshot hyprpaper
