...
echo "deny /etc/ld.so.preload r," >> /etc/apparmor.d/local/code

sed -i 's|profile vscode /usr/share/code{/bin,}/code|profile vscode /usr/{bin/code{,-oss},lib/{code{,-oss},electron42/electron,electron42}}|' /etc/apparmor.d/code
