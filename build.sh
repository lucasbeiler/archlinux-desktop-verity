...
pacstrap -c -K $WORKDIR \
  base ${BASE_DEVEL_WITHOUT_SUDO} wpa_supplicant eza firefox gptfdisk linux-hardened linux-firmware-intel intel-ucode iptables less ntpd-rs dnscrypt-proxy apparmor tpm2-tss tpm2-tools erofs-utils \
  ...
  sway xorg-xwayland firefox kanshi brightnessctl xdg-desktop-portal-wlr mako swayidle swaylock swaybg fuzzel yazi ttf-jetbrains-mono otf-font-awesome
