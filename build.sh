...
pacstrap -P -c -K $WORKDIR \
  base ${BASE_DEVEL_WITHOUT_SUDO} xdelta3 wpa_supplicant bluez bluez-utils eza chromium gptfdisk linux-hardened linux-firmware-intel intel-ucode iptables less ntpd-rs dnscrypt-proxy apparmor tpm2-tss tpm2-tools erofs-utils parted \
  ...
  bubblewrap nmap wl-clipboard slurp grim xdg-desktop-portal alacritty libnotify jq yq patchutils firecracker helix ollama opencode tmux kubectl helm kustomize sops age checksec spotify-player gurk \
...
_pkg="chromium-152.0.7977.64-1-x86_64.pkg.tar.zst"
_url="https://download.opensuse.org/repositories/home:/lucasbeiler/Arch/x86_64/$_pkg"
_expected_sha256="d0584421198853c2d30bf1d9940338fee9b7ee5e9fde0d353c3dc89ed50ea046"
