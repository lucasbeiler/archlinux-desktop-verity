...
pacstrap -P -c -K $WORKDIR \
  ...
  bubblewrap-suid nmap wl-clipboard slurp grim xdg-desktop-portal alacritty libnotify jq yq patchutils firecracker helix ollama-vulkan kubectl helm kustomize sops age checksec spotify-player gurk \
