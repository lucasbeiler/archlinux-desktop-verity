...
rm -rf apparmor.d/groups/filesystem/mtools apparmor.d/groups/ssh apparmor.d/profiles-g-l/ip apparmor.d/profiles-g-l/git apparmor.d/groups/procps # Delete policies related to mtools, ssh, ip, git and procps (at least for now...)
...
# systemctl enable firecracker-net-setup.service # TODO: Uncomment once this is ready.
