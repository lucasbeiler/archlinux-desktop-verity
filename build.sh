...
set -euo pipefail
APPARMOR_D_UPSTREAM_COMMIT=e7a9693c3aad5da853cea53bc3f97ff186153a9a # Update this to the commit hash last reviewed at https://github.com/roddhjav/apparmor.d
git clone https://github.com/lucasbeiler/apparmor.d.git /tmp/apparmor.d
cd /tmp/apparmor.d
