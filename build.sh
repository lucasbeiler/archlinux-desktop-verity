...
rm -rf apparmor.d/groups/filesystem/mtools apparmor.d/profiles-a-f/flameshot apparmor.d/groups/ssh apparmor.d/profiles-g-l/git apparmor.d/groups/procps # Delete policies related to mtools, flameshot, ssh, git and procps (for now...)
