...
pacstrap -c -K $WORKDIR \
  ...
  sway kanshi brightnessctl xdg-desktop-portal-wlr mako swayidle swaylock swaybg ttf-jetbrains-mono virtualbox-host-dkms virtualbox
