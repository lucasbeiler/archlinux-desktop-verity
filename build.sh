...
pacstrap -c -K $WORKDIR \
  ...
  river kanshi brightnessctl xdg-desktop-portal-wlr waybar mako waybar swayidle swaylock swaybg fuzzel yazi adobe-source-code-pro-fonts ttf-jetbrains-mono otf-font-awesome
