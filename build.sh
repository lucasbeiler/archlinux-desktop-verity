...
mkdir -p /usr/share/archlinux-desktop-verity/
arch-repro-status > /usr/share/archlinux-desktop-verity/arch-repro-status-report.txt 2>&1 || :
# pacman -Rsn --noconfirm arch-repro-status
