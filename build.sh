...
rm -rf apparmor.d/groups/filesystem/mtools apparmor.d/groups/ssh apparmor.d/profiles-g-l/git apparmor.d/groups/procps apparmor.d/groups/bus/dbus* # Delete policies related to mtools, ssh, git, procps and dbus (at least for now...)
