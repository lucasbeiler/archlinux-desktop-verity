...
echo '/data/var/lib/flatpak      /var/lib/flatpak          none   bind,exec,nosuid,nodev,x-systemd.requires-mounts-for=/data,x-systemd.requires-mounts-for=/var          0  0' >> /etc/fstab
