...
pacstrap -P -c -K $WORKDIR \
  ...
  bubblewrap-suid nmap wl-clipboard slurp grim xdg-desktop-portal alacritty libnotify jq yq patchutils firecracker helix opencode tmux kubectl helm kustomize sops age checksec spotify-player gurk \
