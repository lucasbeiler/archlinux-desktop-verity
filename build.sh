...
rm -rf apparmor.d/groups/ssh apparmor.d/profiles-g-l/git apparmor.d/groups/procps # Delete policies related to ssh, git and procps (for now...)
...
echo "/usr/lib/chromium/chrome-sandbox rPx,"     >> /etc/apparmor.d/local/chromium
echo "@{XDG_CONFIG_DIR}/chromium-flags.conf r," >> /etc/apparmor.d/local/chromium
