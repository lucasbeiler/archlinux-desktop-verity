...
pacstrap -c -K $WORKDIR \
  ...
  jq yq patchutils helix helm kubectl nvim code checksec docker docker-compose age sops fluxcd kustomize opentofu pulumi azure-cli aws-cli flatpak spotify-player \
