...
pacstrap -P -c -K $WORKDIR \
  ...
  sway river waybar wayfire wf-shell labwc kanshi brightnessctl xdg-desktop-portal-wlr mako swayidle swaylock swaybg ttf-jetbrains-mono arch-repro-status rclone rsync
