...
pacstrap -c -K $WORKDIR \
  ...
  sway labwc waybar kanshi brightnessctl xdg-desktop-portal-wlr waybar mako swayidle swaylock swaybg fuzzel yazi adobe-source-code-pro-fonts ttf-jetbrains-mono otf-font-awesome
