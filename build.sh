...
pacstrap -P -c -K $WORKDIR \
  ...
  bubblewrap-suid nmap flameshot slurp grim xdg-desktop-portal alacritty libnotify jq yq patchutils firecracker helix checksec spotify-player gurk \
  kubectl kustomize fluxcd sops age \
