...
pacstrap -c -K $WORKDIR \
  ...
  sway kanshi brightnessctl xdg-desktop-portal-wlr mako swayidle swaylock swaybg ttf-jetbrains-mono 
...
sed -i '/\[core-testing\]/,/^$/s/^#//' /tmp/pacman-custom.conf
pacstrap -C /tmp/pacman-custom.conf -c -K $WORKDIR core-testing/systemd core-testing/systemd-libs core-testing/systemd-sysvcompat core-testing/systemd-ukify || exit 1
...
# TEMPORARY! systemd-boot 261 is changing some TPM 2.0 PCR here.
#rm -f /hardenedos/bootloader-signed.efi
#curl -L -o /hardenedos/bootloader-signed.efi https://github.com/lucasbeiler/archlinux-desktop-verity/releases/download/202606230253/bootloader-signed.efi
