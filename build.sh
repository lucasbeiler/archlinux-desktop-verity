...
rm -rf apparmor.d/groups/browsers/ apparmor.d/groups/code/ apparmor.d/groups/ssh apparmor.d/profiles-g-l/git apparmor.d/groups/procps # Delete policies related to git, ssh, browsers and VSCode (for now...)
